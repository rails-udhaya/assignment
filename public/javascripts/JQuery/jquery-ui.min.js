...
this.menu=b("<ul></ul>").addClass("").appendTo(b(this.options.appendTo||
...
(function(b){
    ...
    refresh:function(){
        var c=this;
        this.element.children("li:not(.ui-menu-item):has(a)").addClass("ui-menu-item").attr("role","menuitem").children("a").addClass("").attr("tabindex",
    ...
    activate:function(c,f){
        ...
        if(this.hasScroll()){
            ...
            if(g<0)this.element.attr("scrollTop",e+g);else g>=a&&this.element.attr("scrollTop",e+g-a+f.height())
                ...
                this.active=f.eq(0).children("a").addClass("ui-state-auto_hover").end();
    ...
    deactivate:function(){
        if(this.active){
            this.active.children("a").removeClass("ui-state-auto_hover").removeAttr("id");
            this._trigger("blur");
            this.active=null
            }
        },
